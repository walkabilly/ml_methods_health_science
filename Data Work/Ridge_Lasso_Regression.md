...
![](Ridge_Lasso_Regression_files/figure-html/unnamed-chunk-1-1.png)<!-- -->
...
![](Ridge_Lasso_Regression_files/figure-html/unnamed-chunk-2-1.png)<!-- -->
...
##  2 SDC_AGE_CALC            0.0239      0.1
##  3 SDC_EDU_LEVEL_AGE       0.0660      0.1
##  4 PA_TOTAL_SHORT         -0.142       0.1
##  5 PSE_ADULT_WRK_DURATION  0.0712      0.1
##  6 SDC_GENDER_X2          -0.0540      0.1
##  7 SDC_MARITAL_STATUS_X2   0.00146     0.1
##  8 SDC_MARITAL_STATUS_X3  -0.0142      0.1
##  9 SDC_MARITAL_STATUS_X4  -0.339       0.1
## 10 SDC_MARITAL_STATUS_X5   0.0172      0.1
## # ℹ 191 more rows
```
...
##  1 0.0000000001    0.367 rmse    standard   6.02       4 0.0251  pre0_mod01_pos…
##  2 0.0000000001    0.367 rsq     standard   0.0684     4 0.00121 pre0_mod01_pos…
##  3 0.00000000129   0.789 rmse    standard   6.02       4 0.0250  pre0_mod02_pos…
##  4 0.00000000129   0.789 rsq     standard   0.0684     4 0.00121 pre0_mod02_pos…
##  5 0.0000000167    0.05  rmse    standard   6.02       4 0.0251  pre0_mod03_pos…
##  6 0.0000000167    0.05  rsq     standard   0.0684     4 0.00122 pre0_mod03_pos…
##  7 0.000000215     0.472 rmse    standard   6.02       4 0.0251  pre0_mod04_pos…
##  8 0.000000215     0.472 rsq     standard   0.0684     4 0.00121 pre0_mod04_pos…
##  9 0.00000278      0.894 rmse    standard   6.02       4 0.0251  pre0_mod05_pos…
## 10 0.00000278      0.894 rsq     standard   0.0684     4 0.00122 pre0_mod05_pos…
## 11 0.0000359       0.156 rmse    standard   6.02       4 0.0251  pre0_mod06_pos…
## 12 0.0000359       0.156 rsq     standard   0.0684     4 0.00122 pre0_mod06_pos…
## 13 0.000464        0.578 rmse    standard   6.02       4 0.0251  pre0_mod07_pos…
## 14 0.000464        0.578 rsq     standard   0.0685     4 0.00123 pre0_mod07_pos…
## 15 0.00599         1     rmse    standard   6.02       4 0.0253  pre0_mod08_pos…
## 16 0.00599         1     rsq     standard   0.0702     4 0.00131 pre0_mod08_pos…
## 17 0.0774          0.261 rmse    standard   6.00       4 0.0259  pre0_mod09_pos…
## 18 0.0774          0.261 rsq     standard   0.0725     4 0.00143 pre0_mod09_pos…
## 19 1               0.683 rmse    standard   6.18       4 0.0260  pre0_mod10_pos…
## 20 1               0.683 rsq     standard   0.0348     4 0.00100 pre0_mod10_pos…
```
...
##        penalty mixture .metric .estimator  mean     n std_err .config         
##          <dbl>   <dbl> <chr>   <chr>      <dbl> <int>   <dbl> <chr>           
## 1 0.0774         0.261 rmse    standard    6.00     4  0.0259 pre0_mod09_post0
## 2 0.00599        1     rmse    standard    6.02     4  0.0253 pre0_mod08_post0
## 3 0.000464       0.578 rmse    standard    6.02     4  0.0251 pre0_mod07_post0
## 4 0.0000000167   0.05  rmse    standard    6.02     4  0.0251 pre0_mod03_post0
## 5 0.0000359      0.156 rmse    standard    6.02     4  0.0251 pre0_mod06_post0
```
...
![](Ridge_Lasso_Regression_files/figure-html/unnamed-chunk-11-1.png)<!-- -->
...
![](Ridge_Lasso_Regression_files/figure-html/unnamed-chunk-11-2.png)<!-- -->
...
![](Ridge_Lasso_Regression_files/figure-html/unnamed-chunk-15-1.png)<!-- -->
